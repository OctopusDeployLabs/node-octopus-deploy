 ...
 * @export
 */
export const SpaceHomeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        getSpaceHome: async (spaceId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'spaceId' is not null or undefined
            assertParamExists('getSpaceHome', 'spaceId', spaceId)
            const localVarPath = `/{spaceId}`
...
export const SpaceHomeApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = SpaceHomeApiAxiosParamCreator(configuration)
    return {
        /**
         * Returns a document describing the specified Space and links to other parts of the API that apply to the Space.
         * @param {string} spaceId ID of the space
         ...
         * @throws {RequiredError}
         */
        async getSpaceHome(spaceId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SpaceRootResource>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSpaceHome(spaceId, options);
 ...
 * @export
 */
export const SpaceHomeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getSpaceHome(spaceId: string, options?: any): AxiosPromise<SpaceRootResource> {
            return localVarFp.getSpaceHome(spaceId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class SpaceHomeApi extends BaseAPI implements SpaceHomeApiInterface {
    ...
    public getSpaceHome(spaceId: string, options?: any) {
        return SpaceHomeApiFp(this.configuration).getSpaceHome(spaceId, options).then((request) => request(this.axios, this.basePath));
    }
}
