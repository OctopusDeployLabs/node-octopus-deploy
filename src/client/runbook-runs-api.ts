 ...
 * @export
 */
export const RunbookRunsApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    createRunbookRunCreateSpaces: async (
      baseSpaceId: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      ...
      const localVarPath = `/{baseSpaceId}/runbookRuns`.replace(
        `{${"baseSpaceId"}}`,
     ...
     * @throws {RequiredError}
     */
    deleteRunbookRun: async (
      id: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("deleteRunbookRun", "id", id);
      const localVarPath = `/runbookRuns/{id}`.replace(
        `{${"id"}}`,
...
export const RunbookRunsApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator = RunbookRunsApiAxiosParamCreator(
    configuration
  );
  return {
    /**
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createRunbookRunCreate(
        options
      );
     ...
     * @throws {RequiredError}
     */
    async createRunbookRunCreateSpaces(
      baseSpaceId: string,
      options?: any
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createRunbookRunCreateSpaces(
        baseSpaceId,
        options
      );
      return createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async deleteRunbookRun(
      id: string,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteRunbookRun(
        id,
        options
      );
      return createRequestFunction(
    ...
    async deleteRunbookRunSpaces(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteRunbookRunSpaces(
        baseSpaceId,
        id,
        options
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getRunbookRunById(
        id,
        options
      );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getRunbookRunByIdSpaces(
        id,
        baseSpaceId,
        options
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.indexRunbookRuns(
        skip,
        take,
        options
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.indexRunbookRunsSpaces(
        baseSpaceId,
        skip,
        take,
        options
 ...
 * @export
 */
export const RunbookRunsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
    ...
    createRunbookRunCreate(options?: any): AxiosPromise<RunbookRunResource> {
      return localVarFp
        .createRunbookRunCreate(options)
    ...
    createRunbookRunCreateSpaces(
      ...
      return localVarFp
        .createRunbookRunCreateSpaces(baseSpaceId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Deletes a runbookRun.
    ...
    deleteRunbookRunSpaces(
      ...
      return localVarFp
        .deleteRunbookRunSpaces(baseSpaceId, id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getRunbookRunByIdSpaces(
      ...
      return localVarFp
        .getRunbookRunByIdSpaces(id, baseSpaceId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists all of the runbookRuns in the supplied Octopus Deploy Space, from projects, snapshots and environments accessible by the current user. The results will be sorted from most recent to least recent runbookRun.
    ...
    indexRunbookRuns(
      ...
      return localVarFp
        .indexRunbookRuns(skip, take, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists all of the runbookRuns in the supplied Octopus Deploy Space, from projects, snapshots and environments accessible by the current user. The results will be sorted from most recent to least recent runbookRun.
    ...
    indexRunbookRunsSpaces(
      ...
      return localVarFp
        .indexRunbookRunsSpaces(baseSpaceId, skip, take, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class RunbookRunsApi extends BaseAPI implements RunbookRunsApiInterface {
  ...
  public createRunbookRunCreate(options?: any) {
    return RunbookRunsApiFp(this.configuration)
      .createRunbookRunCreate(options)
   ...
   * @memberof RunbookRunsApi
   */
  public getRunbookRunByIdSpaces(
    id: string,
    baseSpaceId: string,
    options?: any
  ) {
