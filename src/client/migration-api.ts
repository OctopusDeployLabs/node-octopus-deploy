...
export const MigrationApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    createMigrationPartialExport: async (
      options: any = {}
    ): Promise<RequestArgs> => {
...
export const MigrationApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async createMigrationPartialExport(
      options?: any
    ): Promise<
      (
        axios?: AxiosInstance,
...
export const MigrationApiFactory = function (
  ...
  return {
    ...
    createMigrationPartialExport(
      ...
      return localVarFp
        .createMigrationPartialExport(options)
        .then((request) => request(axios, basePath));
    },
  };
};
