...
export const ProjectsApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    createConvertProjectToVersionControlled: async (
      projectId: string,
      options: any = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    createConvertProjectToVersionControlledSpaces: async (
      baseSpaceId: string,
      projectId: string,
      options: any = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    createProjectLogo: async (
      id: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("createProjectLogo", "id", id);
      const localVarPath = `/projects/{id}/logo`.replace(
        `{${"id"}}`,
    ...
    createProjectSpaces: async (
      ...
      const localVarPath = `/{baseSpaceId}/projects`.replace(
        `{${"baseSpaceId"}}`,
     ...
     * @throws {RequiredError}
     */
    createVersionControlSettingsConnectivityCheck: async (
      id: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      ...
      const localVarPath = `/projects/{id}/versioncontrolsettings/test`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    createVersionControlSettingsConnectivityCheckSpaces: async (
      baseSpaceId: string,
      id: string,
      options: any = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getProjectByIdOrSlugSpaces: async (
      baseSpaceId: string,
      id: string,
      options: any = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getProjectSettingsMetadata: async (
      id: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("getProjectSettingsMetadata", "id", id);
      const localVarPath = `/projects/{id}/metadata`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getProjectSettingsMetadataSpaces: async (
      baseSpaceId: string,
      id: string,
      options: any = {}
    ): Promise<RequestArgs> => {
    ...
    getProjectSummary: async (
      ...
      const localVarPath = `/projects/{id}/summary`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    listAllProjectsSpaces: async (
      baseSpaceId: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'baseSpaceId' is not null or undefined
      assertParamExists("listAllProjectsSpaces", "baseSpaceId", baseSpaceId);
      const localVarPath = `/{baseSpaceId}/projects/all`.replace(
        `{${"baseSpaceId"}}`,
        encodeURIComponent(String(baseSpaceId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const ProjectsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async createConvertProjectToVersionControlled(
      projectId: string,
      options?: any
    ): Promise<
      (
     ...
     * @throws {RequiredError}
     */
    async createConvertProjectToVersionControlledSpaces(
      baseSpaceId: string,
      projectId: string,
      options?: any
    ): Promise<
     ...
     * @throws {RequiredError}
     */
    async createVersionControlSettingsConnectivityCheck(
      id: string,
      options?: any
    ): Promise<
      (
     ...
     * @throws {RequiredError}
     */
    async createVersionControlSettingsConnectivityCheckSpaces(
      baseSpaceId: string,
      id: string,
      options?: any
    ): Promise<
     ...
     * @throws {RequiredError}
     */
    async getProjectByIdOrSlugSpaces(
      baseSpaceId: string,
      id: string,
      options?: any
    ): Promise<
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getProjectLogo(
        id,
        options
      );
      return createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async getProjectSettingsMetadata(
      id: string,
      options?: any
    ): Promise<
      (
     ...
     * @throws {RequiredError}
     */
    async getProjectSettingsMetadataSpaces(
      baseSpaceId: string,
      id: string,
      options?: any
    ): Promise<
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.indexProjects(
        skip,
        take,
        options
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listAllProjects(
        options
      );
      return createRequestFunction(
        localVarAxiosArgs,
...
export const ProjectsApiFactory = function (
  ...
  return {
    ...
    createConvertProjectToVersionControlled(
      ...
      return localVarFp
        .createConvertProjectToVersionControlled(projectId, options)
    ...
    createProject(
      ...
      return localVarFp
        .createProject(clone, body, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Updates the logo associated with the project.
    ...
    createProjectLogoSpaces(
      ...
      return localVarFp
        .createProjectLogoSpaces(baseSpaceId, id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Creates a new project.
    ...
    createProjectSpaces(
      ...
      return localVarFp
        .createProjectSpaces(baseSpaceId, clone, body, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Tests the VCS settings to make sure we can connect
    ...
    createVersionControlSettingsConnectivityCheck(
      ...
      return localVarFp
        .createVersionControlSettingsConnectivityCheck(id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Tests the VCS settings to make sure we can connect
    ...
    deleteProjectSpaces(
      ...
      return localVarFp
        .deleteProjectSpaces(baseSpaceId, id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Gets a single project by ID or Slug.
    ...
    getProjectByIdOrSlug(
      ...
      return localVarFp
        .getProjectByIdOrSlug(id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Gets a single project by ID or Slug.
    ...
    getProjectByIdOrSlugSpaces(
      ...
      return localVarFp
        .getProjectByIdOrSlugSpaces(baseSpaceId, id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Gets the logo associated with the project.
    ...
    getProjectLogoSpaces(
      ...
      return localVarFp
        .getProjectLogoSpaces(baseSpaceId, id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Gets the custom settings metadata from the extensions.
    ...
    getProjectSettingsMetadata(
      ...
      return localVarFp
        .getProjectSettingsMetadata(id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Gets the custom settings metadata from the extensions.
    ...
    getProjectSettingsMetadataSpaces(
      ...
      return localVarFp
        .getProjectSettingsMetadataSpaces(baseSpaceId, id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Gets a summary of project-specific information.
    ...
    getProjectSummarySpaces(
      ...
      return localVarFp
        .getProjectSummarySpaces(baseSpaceId, id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists all of the projects in the supplied Octopus Deploy Space, from all project groups. The results will be sorted alphabetically by name.
    ...
    indexProjects(
      ...
      return localVarFp
        .indexProjects(skip, take, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists all of the projects in the supplied Octopus Deploy Space, from all project groups. The results will be sorted alphabetically by name.
    ...
    indexProjectsSpaces(
      ...
      return localVarFp
        .indexProjectsSpaces(baseSpaceId, skip, take, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists the name and ID of all of the projects in the supplied Octopus Deploy Space. The results will be sorted alphabetically by name.
    ...
    listAllProjectsSpaces(
      ...
      return localVarFp
        .listAllProjectsSpaces(baseSpaceId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Modifies an existing project.
    ...
    updateProjectLogoSpaces(
      ...
      return localVarFp
        .updateProjectLogoSpaces(baseSpaceId, id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Modifies an existing project.
    ...
    updateProjectSpaces(
      ...
      return localVarFp
        .updateProjectSpaces(baseSpaceId, id, body, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class ProjectsApi extends BaseAPI implements ProjectsApiInterface {
   ...
   */
  public createConvertProjectToVersionControlled(
    projectId: string,
    options?: any
  ) {
   ...
   * @memberof ProjectsApi
   */
  public createConvertProjectToVersionControlledSpaces(
    baseSpaceId: string,
    projectId: string,
    options?: any
  ) {
   ...
   * @memberof ProjectsApi
   */
  public createProjectLogoSpaces(
    baseSpaceId: string,
    id: string,
    options?: any
  ) {
   ...
   * @memberof ProjectsApi
   */
  public createVersionControlSettingsConnectivityCheck(
    id: string,
    options?: any
  ) {
    return ProjectsApiFp(this.configuration)
   ...
   * @memberof ProjectsApi
   */
  public createVersionControlSettingsConnectivityCheckSpaces(
    baseSpaceId: string,
    id: string,
    options?: any
  ) {
   ...
   * @memberof ProjectsApi
   */
  public getProjectByIdOrSlugSpaces(
    baseSpaceId: string,
    id: string,
    options?: any
  ) {
   ...
   * @memberof ProjectsApi
   */
  public getProjectSettingsMetadataSpaces(
    baseSpaceId: string,
    id: string,
    options?: any
  ) {
   ...
   * @memberof ProjectsApi
   */
  public getProjectSummarySpaces(
    baseSpaceId: string,
    id: string,
    options?: any
  ) {
   ...
   * @memberof ProjectsApi
   */
  public updateProjectLogoSpaces(
    baseSpaceId: string,
    id: string,
    options?: any
  ) {
