 ...
 * @export
 */
export const UserOnboardingApiAxiosParamCreator = function (
  ...
  return {
    ...
    getOnboardingSpaces: async (
      ...
      const localVarPath = `/{baseSpaceId}/useronboarding`.replace(
        `{${"baseSpaceId"}}`,
...
export const UserOnboardingApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getOnboarding(
        options
      );
 ...
 * @export
 */
export const UserOnboardingApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
    ...
    getOnboardingSpaces(
      ...
      return localVarFp
        .getOnboardingSpaces(baseSpaceId, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class UserOnboardingApi extends BaseAPI {
  ...
  public getOnboarding(options?: any) {
    return UserOnboardingApiFp(this.configuration)
      .getOnboarding(options)
