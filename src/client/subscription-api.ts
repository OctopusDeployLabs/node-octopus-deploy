...
export const SubscriptionApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    createSubscriptionSpaces: async (
      baseSpaceId: string,
      body?: SubscriptionResource,
      options: any = {}
    ): Promise<RequestArgs> => {
      ...
      const localVarPath = `/{baseSpaceId}/subscriptions`.replace(
        `{${"baseSpaceId"}}`,
     ...
     * @throws {RequiredError}
     */
    deleteSubscriptionSpaces: async (
      baseSpaceId: string,
      id: string,
      options: any = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    indexSubscriptionsSpaces: async (
      baseSpaceId: string,
      skip?: number,
      take?: number,
      options: any = {}
     ...
     * @throws {RequiredError}
     */
    updateSubscriptionSpaces: async (
      baseSpaceId: string,
      id: string,
      body?: SubscriptionResource,
      options: any = {}
...
export const SubscriptionApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator = SubscriptionApiAxiosParamCreator(
    configuration
  );
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    async createSubscriptionSpaces(
      baseSpaceId: string,
      body?: SubscriptionResource,
      options?: any
    ): Promise<
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createSubscriptionSpaces(
        baseSpaceId,
        body,
        options
      );
     ...
     * @throws {RequiredError}
     */
    async deleteSubscriptionSpaces(
      baseSpaceId: string,
      id: string,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteSubscriptionSpaces(
        baseSpaceId,
        id,
        options
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.indexSubscriptions(
        skip,
        take,
        options
      );
     ...
     * @throws {RequiredError}
     */
    async indexSubscriptionsSpaces(
      baseSpaceId: string,
      skip?: number,
      take?: number,
      options?: any
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.indexSubscriptionsSpaces(
        baseSpaceId,
        skip,
        take,
        options
     ...
     * @throws {RequiredError}
     */
    async updateSubscriptionSpaces(
      baseSpaceId: string,
      id: string,
      body?: SubscriptionResource,
      options?: any
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateSubscriptionSpaces(
        baseSpaceId,
        id,
        body,
        options
...
export const SubscriptionApiFactory = function (
  ...
  return {
    ...
    createSubscriptionSpaces(
      ...
      return localVarFp
        .createSubscriptionSpaces(baseSpaceId, body, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Deletes an existing subscription.
    ...
    deleteSubscriptionSpaces(
      ...
      return localVarFp
        .deleteSubscriptionSpaces(baseSpaceId, id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists all of the subscriptions in the supplied Octopus Deploy Space. The results will be sorted alphabetically by name.
    ...
    indexSubscriptions(
      ...
      return localVarFp
        .indexSubscriptions(skip, take, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists all of the subscriptions in the supplied Octopus Deploy Space. The results will be sorted alphabetically by name.
    ...
    indexSubscriptionsSpaces(
      ...
      return localVarFp
        .indexSubscriptionsSpaces(baseSpaceId, skip, take, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Updates an existing subscription
    ...
    updateSubscriptionSpaces(
      ...
      return localVarFp
        .updateSubscriptionSpaces(baseSpaceId, id, body, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class SubscriptionApi
   ...
   * @memberof SubscriptionApi
   */
  public createSubscriptionSpaces(
    baseSpaceId: string,
    body?: SubscriptionResource,
    options?: any
  ) {
   ...
   * @memberof SubscriptionApi
   */
  public deleteSubscriptionSpaces(
    baseSpaceId: string,
    id: string,
    options?: any
  ) {
   ...
   * @memberof SubscriptionApi
   */
  public indexSubscriptionsSpaces(
    baseSpaceId: string,
    skip?: number,
    take?: number,
    options?: any
   ...
   * @memberof SubscriptionApi
   */
  public updateSubscriptionSpaces(
    baseSpaceId: string,
    id: string,
    body?: SubscriptionResource,
    options?: any
