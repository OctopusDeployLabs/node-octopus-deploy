  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createSubscription(body, options);
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createSubscriptionSpaces(
          baseSpaceId,
          body,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteSubscriptionSpaces(
          baseSpaceId,
          id,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.indexSubscriptions(skip, take, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.indexSubscriptionsSpaces(
          baseSpaceId,
          skip,
          take,
          options
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateSubscription(id, body, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateSubscriptionSpaces(
          baseSpaceId,
          id,
          body,
          options
