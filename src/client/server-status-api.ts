...
export const ServerStatusApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createSystemGarbageCollect: async (options: any = {}): Promise<RequestArgs> => {
...
export const ServerStatusApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createSystemGarbageCollect(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createSystemGarbageCollect(options);
         ...
         * @throws {RequiredError}
         */
        async getExtensionStats(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ExtensionsInfoResource>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getExtensionStats(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Lists timezones supported by the server.
         ...
         * @throws {RequiredError}
         */
        async getListServerTimezones(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ServerTimezoneResource>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getListServerTimezones(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieves the most recent high-priority log messages from this execution of the Octopus Server process.
         ...
         * @throws {RequiredError}
         */
        async getRecentLogs(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getRecentLogs(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Shows information about the status of the Octopus Server.
         ...
         * @throws {RequiredError}
         */
        async getServerStatus(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async getServerStatusHealth(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServerStatusHealthResource>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getServerStatusHealth(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Provides information about the Octopus Server process and the machine on which it is running.
         ...
         * @throws {RequiredError}
         */
        async getSystemInfo(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async getSystemReport(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSystemReport(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ServerStatusApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        createSystemGarbageCollect(options?: any): AxiosPromise<void> {
            return localVarFp.createSystemGarbageCollect(options).then((request) => request(axios, basePath));
        },
        /**
         * Provides statistics for the loaded server extensions.
         * @param {*} [options] Override http request option.
        ...
        getExtensionStats(options?: any): AxiosPromise<Array<ExtensionsInfoResource>> {
            return localVarFp.getExtensionStats(options).then((request) => request(axios, basePath));
        },
        /**
         * Lists timezones supported by the server.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getListServerTimezones(options?: any): AxiosPromise<Array<ServerTimezoneResource>> {
            return localVarFp.getListServerTimezones(options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves the most recent high-priority log messages from this execution of the Octopus Server process.
         * @param {*} [options] Override http request option.
        ...
        getRecentLogs(options?: any): AxiosPromise<void> {
            return localVarFp.getRecentLogs(options).then((request) => request(axios, basePath));
        },
        /**
         * Shows information about the status of the Octopus Server.
         * @param {*} [options] Override http request option.
         ...
         * @throws {RequiredError}
         */
        getServerStatusHealth(options?: any): AxiosPromise<ServerStatusHealthResource> {
            return localVarFp.getServerStatusHealth(options).then((request) => request(axios, basePath));
        },
        /**
         * Provides information about the Octopus Server process and the machine on which it is running.
         * @param {*} [options] Override http request option.
        ...
        getSystemReport(options?: any): AxiosPromise<void> {
            return localVarFp.getSystemReport(options).then((request) => request(axios, basePath));
        },
    };
};
 ...
 * @extends {BaseAPI}
 */
export class ServerStatusApi extends BaseAPI implements ServerStatusApiInterface {
    /**
     * Forces a GC collect.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
    ...
    public createSystemGarbageCollect(options?: any) {
        return ServerStatusApiFp(this.configuration).createSystemGarbageCollect(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getExtensionStats(options?: any) {
        return ServerStatusApiFp(this.configuration).getExtensionStats(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getListServerTimezones(options?: any) {
        return ServerStatusApiFp(this.configuration).getListServerTimezones(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getRecentLogs(options?: any) {
        return ServerStatusApiFp(this.configuration).getRecentLogs(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getServerStatus(options?: any) {
        return ServerStatusApiFp(this.configuration).getServerStatus(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getServerStatusHealth(options?: any) {
        return ServerStatusApiFp(this.configuration).getServerStatusHealth(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getSystemInfo(options?: any) {
        return ServerStatusApiFp(this.configuration).getSystemInfo(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getSystemReport(options?: any) {
        return ServerStatusApiFp(this.configuration).getSystemReport(options).then((request) => request(this.axios, this.basePath));
    }
}
