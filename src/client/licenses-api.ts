...
export const LicensesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getLicenseStatusGetCurrent: async (options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        updateLicensePutCurrent: async (options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/licenses/licenses-current`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const LicensesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getLicenseGetCurrent(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LicenseResource>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getLicenseGetCurrent(options);
         ...
         * @throws {RequiredError}
         */
        async getLicenseStatusGetCurrent(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LicenseStatusResource>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getLicenseStatusGetCurrent(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Updates the license for the Octopus cluster.
         ...
         * @throws {RequiredError}
         */
        async updateLicensePutCurrent(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LicenseResource>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateLicensePutCurrent(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const LicensesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getLicenseGetCurrent(options?: any): AxiosPromise<LicenseResource> {
            return localVarFp.getLicenseGetCurrent(options).then((request) => request(axios, basePath));
        },
        /**
         * Calculates the status of the current Octopus license including compliance and maintenance expiry.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getLicenseStatusGetCurrent(options?: any): AxiosPromise<LicenseStatusResource> {
            return localVarFp.getLicenseStatusGetCurrent(options).then((request) => request(axios, basePath));
        },
        /**
         * Updates the license for the Octopus cluster.
         * @param {*} [options] Override http request option.
        ...
        updateLicensePutCurrent(options?: any): AxiosPromise<LicenseResource> {
            return localVarFp.updateLicensePutCurrent(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class LicensesApi extends BaseAPI implements LicensesApiInterface {
    ...
    public getLicenseGetCurrent(options?: any) {
        return LicensesApiFp(this.configuration).getLicenseGetCurrent(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getLicenseStatusGetCurrent(options?: any) {
        return LicensesApiFp(this.configuration).getLicenseStatusGetCurrent(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public updateLicensePutCurrent(options?: any) {
        return LicensesApiFp(this.configuration).updateLicensePutCurrent(options).then((request) => request(this.axios, this.basePath));
    }
}
