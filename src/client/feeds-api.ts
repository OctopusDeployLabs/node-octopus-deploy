...
export const FeedsApiAxiosParamCreator = function (
  ...
  return {
    ...
    createFeedSpaces: async (
      ...
      const localVarPath = `/{baseSpaceId}/feeds`.replace(
        `{${"baseSpaceId"}}`,
     ...
     * @throws {RequiredError}
     */
    getBuiltInFeedStatsSpaces: async (
      baseSpaceId: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'baseSpaceId' is not null or undefined
      ...
      const localVarPath = `/{baseSpaceId}/feeds/stats`.replace(
        `{${"baseSpaceId"}}`,
        encodeURIComponent(String(baseSpaceId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getPackageSearch: async (
      id: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("getPackageSearch", "id", id);
      const localVarPath = `/feeds/{id}/packages/search`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getPackageVersionSearch: async (
      ...
      const localVarPath = `/feeds/{id}/packages/versions`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getPackageVersionSearchSpaces: async (
      baseSpaceId: string,
      id: string,
      packageId: string,
      options: any = {}
     ...
     * @throws {RequiredError}
     */
    listAllFeedsSpaces: async (
      baseSpaceId: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'baseSpaceId' is not null or undefined
      assertParamExists("listAllFeedsSpaces", "baseSpaceId", baseSpaceId);
      const localVarPath = `/{baseSpaceId}/feeds/all`.replace(
        `{${"baseSpaceId"}}`,
        encodeURIComponent(String(baseSpaceId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const FeedsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createFeed(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResource>
    > {
    ...
    async createFeedSpaces(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResource>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createFeedSpaces(
        baseSpaceId,
        body,
        options
      );
    ...
    async deleteFeedSpaces(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteFeedSpaces(
        baseSpaceId,
        id,
        options
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getBuiltInFeedStats(
        options
      );
      return createRequestFunction(
        localVarAxiosArgs,
     ...
     * @throws {RequiredError}
     */
    async getBuiltInFeedStatsSpaces(
      baseSpaceId: string,
      options?: any
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getBuiltInFeedStatsSpaces(
        baseSpaceId,
        options
      );
      return createRequestFunction(
    ...
    async getFeedById(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResource>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getFeedById(
        id,
        options
      );
      return createRequestFunction(
    ...
    async getFeedByIdSpaces(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResource>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getFeedByIdSpaces(
        baseSpaceId,
        id,
        options
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getPackageSearch(
        id,
        options
      );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getPackageSearchSpaces(
        baseSpaceId,
        id,
        options
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getPackageVersionSearch(
        id,
        packageId,
        options
      );
     ...
     * @throws {RequiredError}
     */
    async getPackageVersionSearchSpaces(
      baseSpaceId: string,
      id: string,
      packageId: string,
      options?: any
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getPackageVersionSearchSpaces(
        baseSpaceId,
        id,
        packageId,
        options
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.indexFeeds(
        skip,
        take,
        options
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.indexFeedsSpaces(
        baseSpaceId,
        skip,
        take,
        options
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listAllFeeds(
        options
      );
      return createRequestFunction(
        localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listAllFeedsSpaces(
        baseSpaceId,
        options
      );
      return createRequestFunction(
    ...
    async updateFeedSpaces(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResource>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateFeedSpaces(
        baseSpaceId,
        id,
        body,
        options
...
export const FeedsApiFactory = function (
  ...
  return {
    ...
    createFeedSpaces(
      ...
      return localVarFp
        .createFeedSpaces(baseSpaceId, body, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Deletes an existing feed.
    ...
    deleteFeedSpaces(
      ...
      return localVarFp
        .deleteFeedSpaces(baseSpaceId, id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Provides statistics for the built-in package repository.
    ...
    getBuiltInFeedStatsSpaces(
      ...
      return localVarFp
        .getBuiltInFeedStatsSpaces(baseSpaceId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Gets a single feed by ID.
    ...
    getFeedByIdSpaces(
      ...
      return localVarFp
        .getFeedByIdSpaces(baseSpaceId, id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Searches the specified feed for packages based on the specified search term
    ...
    getPackageSearchSpaces(
      ...
      return localVarFp
        .getPackageSearchSpaces(baseSpaceId, id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists available versions of the package specified
    ...
    getPackageVersionSearch(
      ...
      return localVarFp
        .getPackageVersionSearch(id, packageId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists available versions of the package specified
    ...
    getPackageVersionSearchSpaces(
      ...
      return localVarFp
        .getPackageVersionSearchSpaces(baseSpaceId, id, packageId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists all the feeds used by the current Octopus installation. The results will be sorted alphabetically by name.
    ...
    indexFeedsSpaces(
      ...
      return localVarFp
        .indexFeedsSpaces(baseSpaceId, skip, take, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists all the feeds in the specified Octopus Deploy Space.
    ...
    listAllFeedsSpaces(
      ...
      return localVarFp
        .listAllFeedsSpaces(baseSpaceId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Modifies an existing feed.
    ...
    updateFeedSpaces(
      ...
      return localVarFp
        .updateFeedSpaces(baseSpaceId, id, body, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class FeedsApi extends BaseAPI implements FeedsApiInterface {
   ...
   * @memberof FeedsApi
   */
  public getPackageVersionSearchSpaces(
    baseSpaceId: string,
    id: string,
    packageId: string,
    options?: any
