 ...
 * @export
 */
export const WorkerPoolsApiAxiosParamCreator = function (
  ...
  return {
    ...
    createWorkerPoolSpaces: async (
      ...
      const localVarPath = `/{baseSpaceId}/workerpools`.replace(
        `{${"baseSpaceId"}}`,
     ...
     * @throws {RequiredError}
     */
    deleteWorkerPool: async (
      id: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("deleteWorkerPool", "id", id);
      const localVarPath = `/workerpools/{id}`.replace(
        `{${"id"}}`,
     ...
     * @throws {RequiredError}
     */
    getWorkerPoolDynamicWorkerTypes: async (
      options: any = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getWorkerPoolDynamicWorkerTypesSpaces: async (
      baseSpaceId: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'baseSpaceId' is not null or undefined
     ...
     * @throws {RequiredError}
     */
    getWorkerPoolSupportedTypes: async (
      options: any = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getWorkerPoolSupportedTypesSpaces: async (
      baseSpaceId: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'baseSpaceId' is not null or undefined
      ...
      const localVarPath = `/{baseSpaceId}/workerpools/supportedtypes`.replace(
        `{${"baseSpaceId"}}`,
        encodeURIComponent(String(baseSpaceId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getWorkerPoolsSummarySpaces: async (
      baseSpaceId: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'baseSpaceId' is not null or undefined
      ...
      const localVarPath = `/{baseSpaceId}/workerpools/summary`.replace(
        `{${"baseSpaceId"}}`,
        encodeURIComponent(String(baseSpaceId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    indexWorkerPoolWorkers: async (
      ...
      const localVarPath = `/workerpools/{id}/workers`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    indexWorkerPoolWorkersSpaces: async (
      baseSpaceId: string,
      id: string,
      skip?: number,
      take?: number,
    ...
    listAllWorkerPoolsSpaces: async (
      ...
      const localVarPath = `/{baseSpaceId}/workerpools/all`.replace(
        `{${"baseSpaceId"}}`,
        encodeURIComponent(String(baseSpaceId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    updateSortWorkerPoolsSpaces: async (
      baseSpaceId: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'baseSpaceId' is not null or undefined
      ...
      const localVarPath = `/{baseSpaceId}/workerpools/sortorder`.replace(
        `{${"baseSpaceId"}}`,
        encodeURIComponent(String(baseSpaceId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const WorkerPoolsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getWorkerPoolDynamicWorkerTypes(
      options?: any
    ): Promise<
      (
        axios?: AxiosInstance,
     ...
     * @throws {RequiredError}
     */
    async getWorkerPoolDynamicWorkerTypesSpaces(
      baseSpaceId: string,
      options?: any
    ): Promise<
      (
     ...
     * @throws {RequiredError}
     */
    async getWorkerPoolSupportedTypes(
      options?: any
    ): Promise<
      (
        axios?: AxiosInstance,
     ...
     * @throws {RequiredError}
     */
    async getWorkerPoolSupportedTypesSpaces(
      baseSpaceId: string,
      options?: any
    ): Promise<
      (
     ...
     * @throws {RequiredError}
     */
    async getWorkerPoolsSummarySpaces(
      baseSpaceId: string,
      options?: any
    ): Promise<
      (
     ...
     * @throws {RequiredError}
     */
    async indexWorkerPoolWorkersSpaces(
      baseSpaceId: string,
      id: string,
      skip?: number,
      take?: number,
     ...
     * @throws {RequiredError}
     */
    async updateSortWorkerPoolsSpaces(
      baseSpaceId: string,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
 ...
 * @export
 */
export const WorkerPoolsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
    ...
    createWorkerPoolSpaces(
      ...
      return localVarFp
        .createWorkerPoolSpaces(baseSpaceId, body, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Deletes an existing pool.
    ...
    deleteWorkerPoolSpaces(
      ...
      return localVarFp
        .deleteWorkerPoolSpaces(baseSpaceId, id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getWorkerPoolByIdSpaces(
      ...
      return localVarFp
        .getWorkerPoolByIdSpaces(id, baseSpaceId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists the available Worker Types for the Dynamic Worker Pool
    ...
    getWorkerPoolDynamicWorkerTypes(
      ...
      return localVarFp
        .getWorkerPoolDynamicWorkerTypes(options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists the available Worker Types for the Dynamic Worker Pool
    ...
    getWorkerPoolDynamicWorkerTypesSpaces(
      ...
      return localVarFp
        .getWorkerPoolDynamicWorkerTypesSpaces(baseSpaceId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists the available Worker Pool types.
    ...
    getWorkerPoolSupportedTypes(
      ...
      return localVarFp
        .getWorkerPoolSupportedTypes(options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists the available Worker Pool types.
    ...
    getWorkerPoolSupportedTypesSpaces(
      ...
      return localVarFp
        .getWorkerPoolSupportedTypesSpaces(baseSpaceId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists all worker pools, including a summary of machine information
    ...
    getWorkerPoolsSummarySpaces(
      ...
      return localVarFp
        .getWorkerPoolsSummarySpaces(baseSpaceId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists all of the machines that belong to the given worker pool.
    ...
    indexWorkerPoolWorkers(
      ...
      return localVarFp
        .indexWorkerPoolWorkers(id, skip, take, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists all of the machines that belong to the given worker pool.
    ...
    indexWorkerPoolWorkersSpaces(
      ...
      return localVarFp
        .indexWorkerPoolWorkersSpaces(baseSpaceId, id, skip, take, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists all of the worker pools in the supplied Octopus Deploy Space. The results will be sorted by the `SortOrder` field on each environment.
    ...
    indexWorkerPools(
      ...
      return localVarFp
        .indexWorkerPools(skip, take, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists all of the worker pools in the supplied Octopus Deploy Space. The results will be sorted by the `SortOrder` field on each environment.
    ...
    indexWorkerPoolsSpaces(
      ...
      return localVarFp
        .indexWorkerPoolsSpaces(baseSpaceId, skip, take, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists the name and ID of all of the Worker Pools in the supplied Octopus Deploy Space. The results will be sorted by the `SortOrder` field on each Worker Pool.
    ...
    updateSortWorkerPoolsSpaces(
      ...
      return localVarFp
        .updateSortWorkerPoolsSpaces(baseSpaceId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Modifies an existing worker pool.
    ...
    updateWorkerPool(
      ...
      return localVarFp
        .updateWorkerPool(id, body, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Modifies an existing worker pool.
    ...
    updateWorkerPoolSpaces(
      ...
      return localVarFp
        .updateWorkerPoolSpaces(baseSpaceId, id, body, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class WorkerPoolsApi extends BaseAPI implements WorkerPoolsApiInterface {
   ...
   * @memberof WorkerPoolsApi
   */
  public getWorkerPoolByIdSpaces(
    id: string,
    baseSpaceId: string,
    options?: any
  ) {
   ...
   * @memberof WorkerPoolsApi
   */
  public getWorkerPoolDynamicWorkerTypesSpaces(
    baseSpaceId: string,
    options?: any
  ) {
    return WorkerPoolsApiFp(this.configuration)
   ...
   * @memberof WorkerPoolsApi
   */
  public indexWorkerPoolWorkersSpaces(
    baseSpaceId: string,
    id: string,
    skip?: number,
    take?: number,
