 ...
 * @export
 */
export const OpenIDConnectApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    createOctopusIDUserAuthenticated: async (
      options: any = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    createOctopusIDUserAuthentication: async (
      options: any = {}
    ): Promise<RequestArgs> => {
...
export const OpenIDConnectApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async createOctopusIDUserAuthenticated(
      options?: any
    ): Promise<
     ...
     * @throws {RequiredError}
     */
    async createOctopusIDUserAuthentication(
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
 ...
 * @export
 */
export const OpenIDConnectApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
    ...
    createOctopusIDUserAuthenticated(options?: any): AxiosPromise<void> {
      return localVarFp
        .createOctopusIDUserAuthenticated(options)
    ...
    createOctopusIDUserAuthentication(options?: any): AxiosPromise<void> {
      return localVarFp
        .createOctopusIDUserAuthentication(options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class OpenIDConnectApi
  ...
  public createOctopusIDUserAuthenticated(options?: any) {
    return OpenIDConnectApiFp(this.configuration)
      .createOctopusIDUserAuthenticated(options)
