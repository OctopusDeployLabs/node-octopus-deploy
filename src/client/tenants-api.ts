  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createTenantLogo(id, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createTenantLogoSpaces(
          id,
          baseSpaceId,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createTenantSpaces(
          baseSpaceId,
          clone,
          body,
          options
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createTenantVariables(
          id,
          body,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createTenantVariablesSpaces(
          id,
          baseSpaceId,
          body,
          options
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteTenantSpaces(
          id,
          baseSpaceId,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getTenantByIdSpaces(
          id,
          baseSpaceId,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getTenantLogoSpaces(
          id,
          baseSpaceId,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getTenantVariablesMissing(
          tenantId,
          projectId,
          environmentId,
          includeDetails,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getTenantVariablesMissingSpaces(
          baseSpaceId,
          tenantId,
          projectId,
          environmentId,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getTenantsConfiguration(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getTenantsConfigurationSpaces(
          baseSpaceId,
          options
        );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getVariablesByTenantId(id, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getVariablesByTenantIdSpaces(
          id,
          baseSpaceId,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.listAllTenantsSpaces(
          baseSpaceId,
          ids,
          projectId,
          tags,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.listTenantsSpaces(
          baseSpaceId,
          projectId,
          ids,
          tags,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.testTenantTagSpaces(
          baseSpaceId,
          tenantIds,
          tags,
          options
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateTenantLogo(id, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateTenantLogoSpaces(
          id,
          baseSpaceId,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateTenantSpaces(
          id,
          baseSpaceId,
          body,
          options
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateTenantVariables(
          id,
          body,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateTenantVariablesSpaces(
          id,
          baseSpaceId,
          body,
          options
