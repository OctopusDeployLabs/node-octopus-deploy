 ...
 * @export
 */
export const TagSetsApiAxiosParamCreator = function (
  ...
  return {
    ...
    createTagSetSpaces: async (
      ...
      const localVarPath = `/{baseSpaceId}/tagsets`.replace(
        `{${"baseSpaceId"}}`,
    ...
    deleteTagSet: async (
      ...
      const localVarPath = `/tagsets/{id}`.replace(
        `{${"id"}}`,
     ...
     * @throws {RequiredError}
     */
    listAllTagSetsSpaces: async (
      baseSpaceId: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'baseSpaceId' is not null or undefined
      assertParamExists("listAllTagSetsSpaces", "baseSpaceId", baseSpaceId);
      const localVarPath = `/{baseSpaceId}/tagsets/all`.replace(
        `{${"baseSpaceId"}}`,
        encodeURIComponent(String(baseSpaceId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    updateSortTagSetsSpaces: async (
      baseSpaceId: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'baseSpaceId' is not null or undefined
      assertParamExists("updateSortTagSetsSpaces", "baseSpaceId", baseSpaceId);
      const localVarPath = `/{baseSpaceId}/tagsets/sortorder`.replace(
        `{${"baseSpaceId"}}`,
        encodeURIComponent(String(baseSpaceId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const TagSetsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createTagSet(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<TagSetResource>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createTagSet(
        body,
        options
      );
    ...
    async createTagSetSpaces(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<TagSetResource>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createTagSetSpaces(
        baseSpaceId,
        body,
        options
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteTagSet(
        id,
        options
      );
      return createRequestFunction(
    ...
    async deleteTagSetSpaces(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteTagSetSpaces(
        baseSpaceId,
        id,
        options
      );
    ...
    async getTagSetById(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<TagSetResource>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getTagSetById(
        id,
        options
      );
      return createRequestFunction(
    ...
    async getTagSetByIdSpaces(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<TagSetResource>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getTagSetByIdSpaces(
        id,
        baseSpaceId,
        options
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.indexTagSets(
        skip,
        take,
        options
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.indexTagSetsSpaces(
        baseSpaceId,
        skip,
        take,
        options
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listAllTagSets(
        options
      );
      return createRequestFunction(
        localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listAllTagSetsSpaces(
        baseSpaceId,
        options
      );
      return createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async updateSortTagSets(
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateSortTagSets(
        options
      );
      return createRequestFunction(
        localVarAxiosArgs,
     ...
     * @throws {RequiredError}
     */
    async updateSortTagSetsSpaces(
      baseSpaceId: string,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateSortTagSetsSpaces(
        baseSpaceId,
        options
      );
      return createRequestFunction(
    ...
    async updateTagSet(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<TagSetResource>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateTagSet(
        id,
        body,
        options
      );
    ...
    async updateTagSetSpaces(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<TagSetResource>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateTagSetSpaces(
        baseSpaceId,
        id,
        body,
        options
 ...
 * @export
 */
export const TagSetsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
    ...
    createTagSetSpaces(
      ...
      return localVarFp
        .createTagSetSpaces(baseSpaceId, body, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Deletes an existing tag set.
    ...
    deleteTagSetSpaces(
      ...
      return localVarFp
        .deleteTagSetSpaces(baseSpaceId, id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getTagSetByIdSpaces(
      ...
      return localVarFp
        .getTagSetByIdSpaces(id, baseSpaceId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists all of the tag sets in the supplied Octopus Deploy Space. The results will be sorted alphabetically by the `SortOrder` field on each tag set.
    ...
    indexTagSets(
      ...
      return localVarFp
        .indexTagSets(skip, take, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists all of the tag sets in the supplied Octopus Deploy Space. The results will be sorted alphabetically by the `SortOrder` field on each tag set.
    ...
    indexTagSetsSpaces(
      ...
      return localVarFp
        .indexTagSetsSpaces(baseSpaceId, skip, take, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Lists the details of all of the Tag Sets in the supplied Octopus Deploy Space. The results will be sorted by the `SortOrder` field on each Tag Set.
    ...
    listAllTagSetsSpaces(
      ...
      return localVarFp
        .listAllTagSetsSpaces(baseSpaceId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Takes an array of tag set IDs as the request body, uses the order of items in the array to sort the tag sets on the server. The ID of every tag set must be specified.
    ...
    updateSortTagSetsSpaces(
      ...
      return localVarFp
        .updateSortTagSetsSpaces(baseSpaceId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Modifies an existing tag set.
    ...
    updateTagSetSpaces(
      ...
      return localVarFp
        .updateTagSetSpaces(baseSpaceId, id, body, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class TagSetsApi extends BaseAPI implements TagSetsApiInterface {
  ...
  public createTagSet(body?: TagSetResource, options?: any) {
    return TagSetsApiFp(this.configuration)
      .createTagSet(body, options)
   ...
   * @memberof TagSetsApi
   */
  public getTagSetByIdSpaces(id: string, baseSpaceId: string, options?: any) {
    return TagSetsApiFp(this.configuration)
      .getTagSetByIdSpaces(id, baseSpaceId, options)
      .then((request) => request(this.axios, this.basePath));
  }
